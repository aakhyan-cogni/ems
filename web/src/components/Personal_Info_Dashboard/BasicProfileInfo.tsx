    ...
    <div className="container-fluid h-100 d-flex flex-column personal-wrapper">
      <div className="flex-shrink-0">
        <div className="d-flex align-items-center w-100 overflow-hidden">
          ...
          />
          <h4 className={`mt-1 text-info`}>{section}</h4>
        </div>
        ...
        <form className="px-3 pb-3" onSubmit={(e) => e.preventDefault()}>
          <div className="row g-3">
			...
			<div className="col-12  d-flex flex-column align-items-center justify-content-center">
				...
				<button className={`w-50 bg-info text-dark border-none form-control rounded-2`} >Change Avatar</button>
			</div>
			...
			<div className="col-12 col-lg-6">
              ...
              {/* <input
                ...
                placeholder="Last Name"
              /> */}
			  <select name="gender" className="form-control" required onChange={()=>setUpdate(true)}>
